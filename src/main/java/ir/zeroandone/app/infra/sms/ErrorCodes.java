package ir.zeroandone.app.infra.sms;
...
public enum ErrorCodes {
    ...
    INVALID_UDH(6, "entered UDH is invalid. in order to sendByHttp a simple message, leave this entry empty"),
    ...
    CREDIT_NOT_ENOUGH(14, "Your credit's not enough to sendByHttp this message. you might want to buy some credit.call "),
    ...
    WEB_RECIPIENT_NUMBER_ARRAY_SIZE_NOT_EQUAL_MESSAGE_ARRAY(101, "when you have N > 1 texts to sendByHttp, you have to define N recipient-numbers..."),
